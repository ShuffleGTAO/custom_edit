...
addCommandHandler("updatecedit",function(plr)
    ...
    fetchRemote("https://raw.githubusercontent.com/sirphantasm/custom_edit/main/custom_edit/meta.xml",function(data,error,path)
        if error==0 then
...
function download()
    ...
    fetchRemote("https://raw.githubusercontent.com/sirphantasm/custom_edit/main/custom_edit/"..files[fileCount],function(data,error,sciezka)
        if error==0 then
